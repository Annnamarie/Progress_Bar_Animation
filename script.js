...
const stepProgressAnimation = (person) => {
  ...
  if (percent === 100) {
    ...
    intervalId = 0;
    reset();
    output.innerHTML = '<p>Hi ' + person.name + ". You're extremely unlucky today... sorry... it's probably because you last ate " + person.lastFood + ", that's a really unlucky food lol. and it doesn't help that your fav number is " + person.number + '</p>';
